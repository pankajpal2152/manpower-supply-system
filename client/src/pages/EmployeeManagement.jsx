...
//             align-items: center;
//             width: 100%;
//             overflow: hidden; /* Ensures inputs never cross sectional width */
//           }

//           .modern-label {
//             flex: 0 0 auto; /* Locks to exact content width */
//             text-align: left;
//             margin-right: 15px; /* Fixed identical gap across entire form */
//             white-space: nowrap;
//             font-size: 0.78rem;
//             font-weight: 800;
//             color: #334155;
...
//           .modern-input,
//           .modern-select {
//             flex: 1 1 auto; /* Fills strictly the remaining container space */
//             width: 100%; /* Stretches properly inside the flex parent */
